...
wget "https://packages.element.io/desktop/install/win32/x64/Element%20Setup.exe" \
    -O Element.exe
wget "https://github.com/element-hq/element-android/releases/download/v1.6.48/vector-gplay-arm64-v8a-release-signed.apk" \
    -O element.apk
